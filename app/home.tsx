  ...
  return (
    <ScrollView style={styles.page} contentContainerStyle={[styles.content, compact && styles.compactContent]}>
      <View style={styles.header}>
        <View style={styles.heading}><Text style={[styles.title, compact && styles.compactTitle]}>Smart Spiżarnia</Text><Text style={styles.subtitle}>Co chcesz dziś zrobić? · wersja 0.8.2</Text></View>
